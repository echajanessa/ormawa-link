@php
    ...
    $userRole = Auth::user()->role_id; // Asumsikan relasi role sudah terdefinisi
@endphp
...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <div class="app-brand demo">
        <a href="{{ url('/dashboard') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-3">Layanan Administrasi Organisasi Mahasiswa</span>
        </a>
